...
public class ConsultaReserva {
       public static LinkedList<reserva> getreservas()
   {
      ...
      try
      {
            ...
            String Consulta = "SELECT id_reserva,registro_reserva,fecha_ingreso,hora_ingreso,fecha_salida,hora_salida,nombre_cabana,cantidad_personas,numero_reserva_interno,nombre_mv,numero_reserva_mv,nombre_cliente,celular_cliente,nombre_fp,fecha_pago,total_a_pagar,total_pagado,saldo_pago,configuracion_cabana,solicitud_especial_cabana,cliente_reserva,estado_reserva\n" +
                                "FROM reservas r \n" +
                                "inner join cabanas c \n" +
                                "on r.id_cabana = c.id_cabana\n" +
            ...
            while (rs.next())
            {
                ...
                //res.setMedio_venta(rs.getInt("id_medio_venta"));
